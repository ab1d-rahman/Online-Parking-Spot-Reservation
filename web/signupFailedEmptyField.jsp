...
<title>Sign Up Unsuccessful</title>
...
<body>
    ...
    <p class="failedMessage">Sign Up Failed!! You need to fill up all the fields.<br><a class="tryAgain" href="signup.jsp">Try Again</a></p>
