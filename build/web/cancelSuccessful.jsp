...
<body>
    ...
    <p class="failedMessage">Cancel Successful!! <br> You have been fined TK <% 
        String fine = (String) request.getSession().getAttribute("currentFine");
        out.println(fine);        
    %> which is 10% of your booking cost!</p>
