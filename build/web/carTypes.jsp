...
<div id="wrapper">
	<div id="three-column" class="container">
		<div class="title">
			<h2>We allow four types of vehicles for you to park!</h2>
                        <br><br><br>
                        <p class="carNames"><img class="carImagges" src="images/private.jpeg" alt="Private Car" ><br>Private Car</p><br>
                        <p class="carNames"><img class="carImagges" src="images/suv.png" alt="SUV" ><br>SUV</p>
                        <p class="carNames"><img class="carImagges" src="images/micro.jpg" alt="Microbus" ><br>Microbus</p>
                        <p class="carNames"><img class="carImagges" src="images/motor.jpg" alt="Motorcycle" ><br>Motorcycle</p>
