...
public class editProfileServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String password, firstName, lastName, phoneNo;
        password = request.getParameter("password");
        firstName = request.getParameter("firstName");
        lastName = request.getParameter("lastName");
        phoneNo = request.getParameter("phoneNo");
        
        userInfo uI = new userInfo(null, password, firstName, lastName, phoneNo);
        
        editProfileService EditProfileService;
        EditProfileService = new editProfileService();
        
        try {
            if(EditProfileService.editProfile(uI, request.getSession())){
                response.sendRedirect("editProfileSuccessful.jsp");
            }
